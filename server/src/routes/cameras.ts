...
router.post('/:id/stream/start-test', requireUser, (req, res) =>
  cameraController.startTestStream(req, res),
);
router.post('/:id/stream/stop-test', requireUser, (req, res) =>
...
router.post('/:id/night-mode', requireUser, (req, res) =>
...
router.put('/:cameraId/zones/:zoneId', requireUser, (req, res) =>
  cameraController.updateZone(req, res),
);
router.delete('/:cameraId/zones/:zoneId', requireUser, (req, res) =>
  cameraController.deleteZone(req, res),
);
...
router.put('/:cameraId/filters/:label', requireUser, (req, res) =>
  cameraController.updateFilter(req, res),
);
router.delete('/:cameraId/filters/:label', requireUser, (req, res) =>
  cameraController.deleteFilter(req, res),
);
