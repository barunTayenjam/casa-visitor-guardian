...
const StreamDashboard = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden flex flex-col">
      ...
      {/* Bottom Control Panel - Slides up from bottom */}
      <div className={cn(
      ...
      {/* Recent Detections Carousel - Always Visible Below Streams */}
      <div className="bg-slate-900/95 backdrop-blur-md border-t border-slate-700 z-10">
        <RecentDetectionsCarousel limit={12} />
      </div>
