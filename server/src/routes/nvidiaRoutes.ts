...
router.post('/analyze-with-bboxes', authenticate(), validateBody(analysisSchema), (req, res) => nvidiaController.analyzeWithBboxes(req, res));
router.post('/analyze-persons', authenticate(), validateBody(analysisSchema), (req, res) => nvidiaController.analyzePersons(req, res));
router.post('/analyze-event-with-bboxes', authenticate(), validateBody(analysisSchema), (req, res) => nvidiaController.analyzeEventWithBboxes(req, res));
