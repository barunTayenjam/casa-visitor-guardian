...
export const EventTimeline: React.FC<EventTimelineProps> = ({
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    setScrollPosition(e.clientX - dragStart);
  };
  const handleMouseUp = () => {
    setIsDragging(false);
    ...
    <div className="mx-5 mb-4 p-[1px] rounded-[1.25rem] bg-white/[0.08]">
      <div className="rounded-[calc(1.25rem-1px)] bg-card/50 backdrop-blur-sm shadow-[inset_0_1px_1px_rgba(255,255,255,0.04)]">
        ...
        >
          ...
          <div
            className="absolute top-8 left-0 right-0 h-12 flex px-4 transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
