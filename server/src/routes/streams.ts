...
// MJPEG streams
router.get('/:cameraId/detect', requireUser, (req, res) =>
  streamController.getDetectStream(req, res),
);
...
router.get('/:cameraId/status', optionalAuth, (req, res) =>
  streamController.getStreamStatus(req, res),
);
