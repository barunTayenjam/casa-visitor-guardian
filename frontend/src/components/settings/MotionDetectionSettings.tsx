...
export const MotionDetectionSettings = forwardRef<
  MotionDetectionSettingsHandle,
  MotionDetectionSettingsProps
>(({ markChanged }, ref) => {
    ...
    <div className="bg-card border border-border rounded-xl p-5 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Select
          ...
          onValueChange={(v) => {
            setSettings((s) => ({ ...s, sensitivity: parseInt(v) }));
            markChanged();
          }}
        >
      ...
      <div className="flex items-center justify-between">
        ...
        <Select
          ...
          onValueChange={(v) => {
            setSettings((s) => ({ ...s, requiredConsecutiveFrames: parseInt(v) }));
            markChanged();
          }}
        >
          <SelectTrigger className="w-28 bg-muted border-input">
      ...
      <div className="flex items-center justify-between">
        ...
        <Select
          ...
          onValueChange={(v) => {
            setSettings((s) => ({ ...s, minContourArea: parseInt(v) }));
            markChanged();
          }}
        >
          <SelectTrigger className="w-28 bg-muted border-input">
