...
> Version 1.7.0 — Resource-optimized home security with real-time AI detection, analytics dashboard, and AI chat.

For full documentation index, see [`DOCS.md`](./DOCS.md).
...
└── *.md                     # Documentation (see DOCS.md index)
```
