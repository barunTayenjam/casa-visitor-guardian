...
export const ConnectionStateOverlay: React.FC<ConnectionStateOverlayProps> = ({
  ...
  if (state === 'error') {
    return (
      <div
        className={cn(
          'absolute inset-0 flex items-center justify-center bg-black/90 backdrop-blur-2xl z-30',
          className,
        )}
      >
  ...
  if (state === 'connecting' || state === 'reconnecting') {
    return (
      <div
        className={cn(
          'absolute inset-0 flex items-center justify-center bg-black/80 backdrop-blur-2xl z-30',
          className,
        )}
      >
