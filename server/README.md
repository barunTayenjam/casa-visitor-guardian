# Casa Visitor Guardian Backend

This is the backend server for the Casa Visitor Guardian system, handling RTSP camera streams, motion detection, and notifications.
