...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      'flex cursor-default select-none items-center rounded-[0.75rem] px-2 py-1.5 text-sm outline-none focus:bg-white/[0.06] data-[state=open]:bg-white/[0.06]',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-[1.25rem] border border-white/[0.14] bg-black/90 backdrop-blur-3xl p-1 text-popover-foreground shadow-lg',
      className,
    )}
    {...props}
  />
